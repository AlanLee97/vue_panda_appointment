            ...
            <el-row>
                ...
                <el-col :span="20"><el-form :model="apt" :rules="rules" ref="apt" label-width="100px" class="demo-apt">
                    ...
                    <el-form-item label="约拍类型" prop="type" align="left">
                        <el-select v-model="apt.type" placeholder="请选择约拍类型">
                    ...
                    <el-form-item label="地点" prop="site">
                        <el-input v-model="apt.site" placeholder="请输入你的约拍地点（尽量详细，建议添加地标建筑进行描述）" type="textarea"></el-input>
                    </el-form-item>

                    <el-form-item label="开始时间" prop="startDatetime">
                        <el-input v-model="apt.startDatetime" placeholder="请输入你的约拍时间（例如：2019年12月31日早上8点）" type="textarea"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="费用" prop="fee">
                        <el-input v-model="apt.fee" placeholder="请输入你的费用（例如：200，100-200，详谈等）" type="textarea"></el-input>
                    </el-form-item>
