<template class="">
    <el-container class="al-width-100 page-reg" direction="vertical">
        ...
        <el-row class="" style="margin: 10% 0 10% 0">
            ...
            <el-col :span="8" class="-border-blue">
                <div style="width:360px"
                     class="al-z-index-99 al-p-20px al-box-shadow-radius al-ma-center"
                >
                    ...
                    <div>
                        <div class="al-title-h1  al-flex-container-center-h">熊猫约拍 - 注册</div>
                    </div>
                    <br>
                    <el-form
                            :model="ruleForm"
...
<script>
    ...
    import {USER_REGISTER} from "@/util/network/api/user/api-user";
